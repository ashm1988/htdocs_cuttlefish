...
<body>
    <table align="center" bgcolor="#CCCCCCC" border="0" cellpadding="3" cellspacing="1" width="300">
        <tr>
            <td>
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            $query = mysqli_query($connect, "SELECT username FROM players WHERE username='$username' and password='$password'");            
